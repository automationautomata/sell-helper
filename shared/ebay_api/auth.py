...
class EbayAuthClient:
    ...
    def authorization_url(self, state: str = "") -> str:
        ...
        domain_type = "" if "sandbox" not in self._url_base else ".sandbox"
        auth_url = f"https://auth{domain_type}.ebay.com/oauth2/authorize"
        return f"{auth_url}?{parse.urlencode(q)}"

    @request_exception_chain(default=EbayAuthError)
    def tokens_by_authorization_code(self, raw_code: str) -> models.GetTokenResponse:
