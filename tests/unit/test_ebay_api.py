...
from app.core.domain.value_objects import AspectValue, AspectType
...
from app....external.ebay_api.commerce import CommerceClientError, EbayCommerceClient
from app....external.ebay_api.selling import EbaySellingClient
from app....external.ebay_api.taxonomy import EbayTaxonomyClient, EbayTaxonomyClientError
        ...
        aspects=[
            ebay_models.Aspect(
                ...
                aspect_constraint=ebay_models.AspectConstraint(
                    aspect_data_type=ebay_models.AspectValueTypeEnum.STRING,
    ...
    ebay_aspects = ebay_models.AspectMetadata(
        aspects=[
            ...
            ebay_models.Aspect(
                ...
                aspect_constraint=ebay_models.AspectConstraint(
                    aspect_data_type=ebay_models.AspectValueTypeEnum.NUMBER,
            ...
            ebay_models.Aspect(
                ...
                aspect_constraint=ebay_models.AspectConstraint(
                    aspect_data_type=ebay_models.AspectValueTypeEnum.STRING_ARRAY,
                    aspect_mode=ebay_models.AspectModeEnum.SELECTION_ONLY,
                    aspect_required=False,
                    aspect_usage=ebay_models.AspectUsageEnum.OPTIONAL,
...
def test_product_to_inventory_item_success(ebay_api):
    ...
    aspect = AspectValue(name="Brand", value="Apple", is_required=False)
