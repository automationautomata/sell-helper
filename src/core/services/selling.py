...
from core.domain.errors import InvalidProductData
from core.domain.question import ProductData, ProductStructure
from core.domain.value_objects import AspectData
